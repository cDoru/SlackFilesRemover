...
namespace SlackCleanup.SlackApiImplementation
{
    public class GroupsApi : IGroupsApi
    {
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.archive", channel => groupId);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.close", channel => groupId);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.create", name => groupName);
            var response = _request.ExecuteAndDeserializeRequest<GroupResponse>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.createChild", channel => groupId);
            var response = _request.ExecuteAndDeserializeRequest<GroupResponse>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.history",
                                        channel => groupId,
                                        latest => latestTs,
                                        oldest => oldestTs,
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.info", channel => groupId);
            var response = _request.ExecuteAndDeserializeRequest<GroupResponse>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.invite", channel => groupId, user => userId);
            var response = _request.ExecuteAndDeserializeRequest<GroupResponse>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.kick", channel => groupId, user => userId);
            var response = _request.ExecuteAndDeserializeRequest<ResponseBase>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.leave", channel => groupId);
            var response = _request.ExecuteAndDeserializeRequest<ResponseBase>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.list", exclude_archived => excludeArchived ? "1" : "0");
            var response = _request.ExecuteAndDeserializeRequest<GroupsResponse>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.mark", channel => groupId, ts => timestamp);
            var response = _request.ExecuteAndDeserializeRequest<ResponseBase>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.open", channel => groupId);
            var response = _request.ExecuteAndDeserializeRequest<ResponseBase>(apiPath);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.rename", channel => groupId, name => groupName);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.setPurpose", channel => groupId, purpose => groupPurpose);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.setTopic", channel => groupId, topic => groupTopic);
        ...
        {
            var apiPath = _request.BuildApiPath("/groups.unarchive", channel => groupId);
            var response = _request.ExecuteAndDeserializeRequest<ResponseBase>(apiPath);
